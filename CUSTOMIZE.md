...
You can create new projects by adding new Markdown files in the [\_work_experience_](_work_experience_/) directory. The easiest way to do this is to copy an existing project and modify it.
...
You can easily create your own collections, apps, short stories, courses, or whatever your creative work is. To do this, edit the collections in the [\_config.yml](_config.yml) file, create a corresponding folder, and create a landing page for your collection, similar to [\_pages/work exp.md](_pages/projects.md).
